...
/* eslint-disable */
// mapboxgl.accessToken = 'pk.eyJ1IjoicHJpeWFsLWJhbnNhbCIsImEiOiJja2JmZjJ3Z2swdXpjMzFwOHUwcWxsMnp3In0.Ih2Cp5KOwUzoZhzV5395tw';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', "Incorrect Email or Password"); //err.response.data.message
...
/* global Stripe */
var stripe = Stripe('pk_test_51Gvd5KAZbfJGK6U8yiXpUWi9tTRxHf4vof9KqB689IGTVFFF8bNn4b3VPQjKj4gJ4ZKIpedlFL9OsFpYz00ZtOQv00inTToGUR');
...
if (bookBtn) //console.log("in book btn");
